...
const galleryItems = [
  ...
  { src: kuchyn7, alt: "Bílá kuchyňská linka na míru s dřevěnými a kamennými detaily", label: "Kuchyně" },
  { src: kuchyn8, alt: "Tmavá kuchyně na míru s dřevěným ostrůvkem a závěsnými svítidly", label: "Kuchyně" },
